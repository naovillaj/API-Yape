const screen8 = (update) =>{
	...
	const divFiu =  $("<div class='col-xs-3 pull-left><span><img src='assets/img/icons/icon.png'></span></div><div class='col-xs-3 pull-left><h4>¿Aún no realizas tu primer pago?</h4><p>Es rápido y sencillo</p></div>");
